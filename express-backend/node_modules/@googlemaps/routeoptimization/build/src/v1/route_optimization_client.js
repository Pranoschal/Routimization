 ...
 */
const gapicConfig = require("./route_optimization_client_config.json");
...
class RouteOptimizationClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const batchOptimizeToursResponse = protoFilesRoot.lookup('.google.maps.routeoptimization.v1.BatchOptimizeToursResponse');
        const batchOptimizeToursMetadata = protoFilesRoot.lookup('.google.maps.routeoptimization.v1.BatchOptimizeToursMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.maps.routeoptimization.v1.RouteOptimization', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.routeOptimizationStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.maps.routeoptimization.v1.RouteOptimization')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.maps.routeoptimization.v1
                    .RouteOptimization, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of routeOptimizationStubMethods) {
            const callPromise = this.routeOptimizationStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=route_optimization_client.js.map